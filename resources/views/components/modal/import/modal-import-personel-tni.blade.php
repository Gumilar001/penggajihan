<x-ui.modal-template modalID="modalImportPersonelTni" modalDialogClasses="modal-dialog-centered"
    modalDialogStyle="max-width:600px;">
    <x-slot name="header">
        <div class="flex flex-col">
            <h5 class="text-base font-bold leading-normal text-gray-800" id="modalImportPersonelTni">
                Import Personel Tni
            </h5>
