<x-ui.modal-template modalID="modalImportUsers" modalDialogClasses="modal-dialog-centered"
    modalDialogStyle="max-width:600px;">
    <x-slot name="header">
        <div class="flex flex-col">
            <h5 class="text-base font-bold leading-normal text-gray-800" id="modalActionBank">
                Import Users
            </h5>
    ...
    <x-slot name="body">
        <div class="mt-2 mb-3">
            ...
            <div class="h-3 relative max-w-xl rounded-full overflow-hidden mt-5">
                <div class="w-full h-full bg-gray-200 absolute"></div>
                <div class="h-full bg-secondary-80 absolute" id="progress"></div>
            </div>
