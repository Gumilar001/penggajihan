                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-2 font-semibold">
                            {{ $view['PersonelId']['pangkatId']->nama_pangkat }}/{{ $view['PersonelId']->nrp }}
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex items-start gap-3">
                                                <div>:</div>
                                                <div>
                                                    Rp. {{currency_IDR($view->t_tpp_pns ?? 0)}}
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex items-start gap-3">
                                                <div>:</div>
                                                <div>
                                                    Rp. {{currency_IDR($view->t_jabatan ?? 0)}}
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex items-start gap-3">
                                                <div>:</div>
                                                <div>
                                                    Rp. {{currency_IDR($view->pot_pensiunan)}}
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex items-start gap-3">
                                                <div>:</div>
                                                <div style="width: 200px;word-break: break-word;">
                                                    Rp. {{currency_IDR($view->pot_tht)}}</div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex items-start gap-3">
                                                <div>:</div>
                                                <div style="width: 200px;word-break: break-word;">
                                                    Rp. {{currency_IDR($view->pot_sewa_rmh)}}</div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex items-start gap-3">
                                                <div>:</div>
                                                <div style="width: 200px;word-break: break-word;">
                                                    Rp. {{currency_IDR($view->pot_pajak_penghasilan)}}</div>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
